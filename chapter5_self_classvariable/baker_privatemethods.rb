...
class Baker
    def bake_cake
        ...
        #Same as caling self.pour_flour - BUT as its a private method, Ruby forbids any explicit receiver of any kind - so it defaults to 'self.method' by force => keeps it private
        @batter = []
        pour_flour
        add_egg
        stir_batter
